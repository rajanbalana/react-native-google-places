...
```
npm i @edgarturrin/react-native-google-places --save
```
OR

```
yarn add @edgarturrin/react-native-google-places
```
...
target '_YOUR_PROJECT_TARGET_' do
  ...
  pod 'react-native-google-places', :path => '../node_modules/@edgarturrin/react-native-google-places'
